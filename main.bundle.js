...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CubeShow; });
/// <reference path="../../../typings/_reference-three.d.ts" />
/// <reference path="../../../typings/_reference-jquery.d.ts" />
var CubeShow = (function () {
...
CubeShow.isMouseDown = false;
//# sourceMappingURL=cube-show.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__cube_show__ = __webpack_require__("../../../../../src/app/components/vr/cube-show.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var VRComponent = (function () {
    ...
    VRComponent.prototype.initCubeShow = function () {
        var _this = this;
        this.showElementReady().then(function () {
            if (__WEBPACK_IMPORTED_MODULE_3__cube_show__["a" /* CubeShow */].appRender == null) {
                var cubeShow = new __WEBPACK_IMPORTED_MODULE_3__cube_show__["a" /* CubeShow */](_this.wanderService);
                cubeShow.create(getShowElement());
            }
            else {
                getShowElement().appendChild(__WEBPACK_IMPORTED_MODULE_3__cube_show__["a" /* CubeShow */].appRender.domElement);
